...
仓库当前处于文档阶段，尚无 Xcode 工程。开始编码前，以技术方案第 5 节的工程结构为基准初始化工程。
...
- M0：风险验证（菜单栏、通知、全屏窗口、沙盒、空闲 API）+ Domain 内核 + 单提醒纵向闭环。
- M1：完整配置与多提醒、系统上下文、多屏与产品完整度。
- M2：封闭测试加固、上架审核预检、数据模型 v1 冻结。
